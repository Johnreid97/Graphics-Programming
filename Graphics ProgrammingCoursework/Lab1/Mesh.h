...
public:
	...
	void sphereDataUpdate(glm::vec3 pos, float radius);

	glm::vec3 getSpherePosition() { return meshSphere.GetPosition(); }
	float getSphereRad() { return meshSphere.GetRadius(); }
...
private:
	...
	unsigned int drawCount; //how much of the vertexArrayObject do we want to create
};