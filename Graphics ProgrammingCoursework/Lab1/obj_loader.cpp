...
void OBJModel::CreateObjectFace(const std::string& line)
{
...
OBJIndex OBJModel::ParseObjectIndex(const std::string& token, bool* hasUVs, bool* hasNormals)
{
...
glm::vec3 OBJModel::ParseObjectVec3(const std::string& line) 
{
...
glm::vec2 OBJModel::ParseObjectVec2(const std::string& line)
{
    unsigned int tokenLength = line.length();
    const char* tokenString = line.c_str();
